/**
 * @file Shell
 * @description HomeSpike's modified copy of Lomiri's Shell.qml. Two
 *   changes from upstream:
 *     1. BFB (Ubuntu-logo button) launches HomeSpike instead of opening
 *        the app drawer.
 *     2. Component.onCompleted auto-launches HomeSpike at shell startup,
 *        so it's the visible surface as soon as the user unlocks.
 *
 *   Original file: /usr/share/lomiri/Shell.qml
...
StyledItem {
    ...
    Component.onCompleted: {
        ...
        // HomeSpike is now loaded inline by Stage.qml as the background
        // layer — no autostart needed, it's always present.
    }
